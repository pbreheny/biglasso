...
real_note_sentence <- function(csv_path, label) {
  ...
  winner_txt <- paste(sprintf("`%s`", names(win_tbl)), collapse = ", ")
  lead <- if (bg_wins == 0) {
...
This article shows how `biglasso` compares to `glmnet`, `ncvreg`, and `picasso`
on simulated and real data sets, covering linear regression, logistic
regression, memory efficiency, and out-of-core ("bigger than RAM") fitting. The
code to rerun all of these benchmarking experiments lives in a separate repository,
...
<img class="r-plt" src="figures/screening_rejection_curves.png" width="500" alt="Fraction of features discarded by each screening rule across the lasso solution path"/>
...
<img class="r-plt" src="figures/vary_n_linear.png" width="420" alt="Linear regression computing time vs. number of observations, by package"/><img class="r-plt" src="figures/vary_p_linear.png" width="420" alt="Linear regression computing time vs. number of features, by package"/>
...
<img class="r-plt" src="figures/vary_n_logistic.png" width="420" alt="Logistic regression computing time vs. number of observations, by package"/><img class="r-plt" src="figures/vary_p_logistic.png" width="420" alt="Logistic regression computing time vs. number of features, by package"/>
...
<img class="r-plt" src="figures/memory_benchmark.png" width="500" alt="Peak resident set size by package, for a single fit and for 10-fold cross-validation"/>
...
<img class="r-plt" src="figures/bigdata_linear_path.png" width="420" alt="Coefficient paths from the out-of-core linear regression fit"/><img class="r-plt" src="figures/bigdata_logistic_path.png" width="420" alt="Coefficient paths from the out-of-core logistic regression fit"/>
