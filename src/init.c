...
extern SEXP cdfit_gaussian_simple_path(SEXP X_, SEXP y_, SEXP r_, SEXP init_,
                                       SEXP xtx_, SEXP penalty_, SEXP lambda_,
                                       SEXP nlambda_, SEXP alpha_, SEXP gamma_,
                                       SEXP eps_, SEXP dfmax_, SEXP max_iter_,
                                       SEXP multiplier_, SEXP ncore_);

// Coordinate descent for mgaussian model
extern SEXP cdfit_mgaussian_ada(SEXP X_, SEXP y_, SEXP row_idx_, SEXP lambda_,
...
extern SEXP cdfit_mgaussian_ssr(SEXP X_, SEXP y_, SEXP row_idx_, SEXP lambda_,
                                SEXP nlambda_, SEXP lam_scale_,
                                SEXP lambda_min_, SEXP alpha_, SEXP user_,
                                SEXP eps_, SEXP max_iter_, SEXP multiplier_,
...
extern SEXP cdfit_cox_scox(SEXP X_, SEXP y_, SEXP d_, SEXP d_idx_,
...
extern SEXP cdfit_cox_ada_scox(SEXP X_, SEXP y_, SEXP d_, SEXP d_idx_,
                               SEXP row_idx_, SEXP lambda_, SEXP nlambda_,
                               SEXP lam_scale_, SEXP lambda_min_, SEXP alpha_,
                               SEXP user_, SEXP eps_, SEXP max_iter_,
                               SEXP multiplier_, SEXP dfmax_, SEXP ncore_,
                               SEXP warn_, SEXP safe_thresh_,
                               SEXP update_thresh_, SEXP verbose_);

extern SEXP cdfit_cox_sscox(SEXP X_, SEXP y_, SEXP d_, SEXP d_idx_,
                            SEXP row_idx_, SEXP lambda_, SEXP nlambda_,
                            SEXP lam_scale_, SEXP lambda_min_, SEXP alpha_,
                            SEXP user_, SEXP eps_, SEXP max_iter_,
                            SEXP multiplier_, SEXP dfmax_, SEXP ncore_,
...
extern SEXP cdfit_cox_safe(SEXP X_, SEXP y_, SEXP d_, SEXP d_idx_,
                           SEXP row_idx_, SEXP lambda_, SEXP nlambda_,
                           SEXP lam_scale_, SEXP lambda_min_, SEXP alpha_,
                           SEXP user_, SEXP eps_, SEXP max_iter_,
                           SEXP multiplier_, SEXP dfmax_, SEXP ncore_,
...
extern SEXP cdfit_binomial_ssr(SEXP X_, SEXP y_, SEXP row_idx_, SEXP lambda_,
                               SEXP nlambda_, SEXP lam_scale_, SEXP lambda_min_,
...
extern SEXP cdfit_binomial_slores_ssr(
...
extern SEXP cdfit_binomial_ada_slores_ssr(
    SEXP X_, SEXP y_, SEXP n_pos_, SEXP ylab_, SEXP row_idx_, SEXP lambda_,
    SEXP nlambda_, SEXP lam_scale_, SEXP lambda_min_, SEXP alpha_, SEXP user_,
    SEXP eps_, SEXP max_iter_, SEXP multiplier_, SEXP dfmax_, SEXP ncore_,
...
extern SEXP cdfit_gaussian_ada_edpp_ssr(SEXP X_, SEXP y_, SEXP row_idx_,
                                        SEXP lambda_, SEXP nlambda_,
...
extern SEXP cdfit_gaussian_ssr(SEXP X_, SEXP y_, SEXP row_idx_, SEXP lambda_,
                               SEXP nlambda_, SEXP lam_scale_, SEXP lambda_min_,
                               SEXP alpha_, SEXP user_, SEXP eps_,
                               SEXP max_iter_, SEXP multiplier_, SEXP dfmax_,
...
extern SEXP _biglasso_get_eta(SEXP xPSEXP, SEXP row_idx_SEXP, SEXP betaSEXP,
                              SEXP idx_pSEXP, SEXP idx_lSEXP);

static R_CallMethodDef callMethods[] = {
    //{"sqsum", (DL_FUNC) &sqsum,}
    {"cdfit_gaussian_simple", (DL_FUNC)&cdfit_gaussian_simple, 14},
    ...
    {"cdfit_binomial_ada_slores_ssr", (DL_FUNC)&cdfit_binomial_ada_slores_ssr,
     20},
